...
import {
  Clock, Lock, Search, FlaskConical, Pill as PillIcon, FileText, Check,
...
// ── category filter — a compact trigger opens this bottom sheet; the picks
//    apply when it closes, so one dismiss is one request ─────────────────────
